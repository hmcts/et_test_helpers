...
Gem::Specification.new do |spec|
  ...
  spec.summary       = %q{Test helpers common to all ET applications}
  spec.description   = %q{Provides test helpers, capybara etc.. to allow easy testing of ET applications (or any GDS application in rails)}
